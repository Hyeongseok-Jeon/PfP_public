...
root_path2 = os.path.dirname(os.getcwd())
sys.path.insert(0, root_path2)
root_path = os.getcwd() + '/bMVC/future_prediction_for_autonomous_vehicle/'
sys.path.insert(0, root_path)

from LaneGCN.argoverse.data_loading.vector_map_loader import load_lane_segments_from_xml
from LaneGCN.argoverse.utils.centerline_utils import (
...
from LaneGCN.argoverse.utils.cv2_plotting_utils import get_img_contours
from LaneGCN.argoverse.utils.dilation_utils import dilate_by_l2
from LaneGCN.argoverse.utils.geometry import point_inside_polygon
from LaneGCN.argoverse.utils.json_utils import read_json_file
from LaneGCN.argoverse.utils.manhattan_search import (
    compute_polygon_bboxes,
    find_all_polygon_bboxes_overlapping_query_bbox,
    find_local_polygons,
)
from LaneGCN.argoverse.utils.mpl_plotting_utils import plot_lane_segment_patch, visualize_centerline
from LaneGCN.argoverse.utils.pkl_utils import load_pkl_dictionary
from LaneGCN.argoverse.utils.se2 import SE2

from .lane_segment import LaneSegment
from .map_viz_helper import render_global_city_map_bev
from LaneGCN.argoverse.utils.interpolate import interp_arc
...
MAP_FILES_ROOT = ROOT / "dataset/map_files"
